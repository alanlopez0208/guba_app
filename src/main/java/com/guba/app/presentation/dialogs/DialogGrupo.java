...
public class DialogGrupo extends Dialog<Grupo> {
    ...
    public DialogGrupo(Grupo grupo){
        ...
        private void inicializarUI(){
            ...
            carreraComboBox.setCellFactory(new Callback<ListView<Carrera>, ListCell<Carrera>>() {
                @Override
            ...
            carreraComboBox.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Carrera>() {
                @Override
                public void changed(ObservableValue<? extends Carrera> observableValue, Carrera carrera, Carrera t1) {
                    semestreComboBox.setDisable(false);
                }
            });
