...
public class MainController implements Initializable, Mediador<Curso> {
    @FXML
    private StackPane stack;
    private Map<Paginas, Node> paginas;
    private Map<Paginas, BaseController<Curso>> controladores;
    private ObservableList<Curso> observableList;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        registrarPagina(Paginas.LIST, "/cursos/List");
        registrarPagina(Paginas.ADD, "/cursos/Add");
    ...
    private void registrarPagina(Paginas pagina, String rutaVista) {
        try {
            ...
            BaseController<Curso> controller= loader.getController();
    ...
    @Override
    public void loadData(Paginas pagina, Curso c) {
        Loadable<Curso> controller = (Loadable<Curso>) controladores.get(pagina);
        if (controller != null) {
