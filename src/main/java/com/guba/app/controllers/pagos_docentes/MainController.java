...
public class MainController implements Mediador<PagoDocente>, Initializable {

    @FXML
    private StackPane stack;
    private Map<Paginas, Node> paginas;
    private Map<Paginas, BaseController<PagoDocente>> controladores;
    private ObservableList<PagoDocente> observableList;
    ...
    @Override
    public void loadData(Paginas pagina, PagoDocente c) {
        Loadable<PagoDocente> controller = (Loadable<PagoDocente>) controladores.get(pagina);
        if (controller != null) {
    ...
    @Override
    public List<PagoDocente> loadData() {
        return null;
    }
    ...
    private void registrarPagina(Paginas pagina, String rutaVista) {
        try {
            ...
            BaseController<PagoDocente> controller= loader.getController();
